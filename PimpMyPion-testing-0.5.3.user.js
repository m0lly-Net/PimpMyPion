// ==UserScript==
// @name         Dreadcast - PimpMyPion - Testing v 0.5.3
...
(function () {
  ...
  const CONFIG = Object.freeze({
    ...
    // Paramétrage des groupes de pions (2 pions ou plus sur même case)
    ...
    getPanelHTML: () => `
      ...
      <div style="display: flex !important; align-items: center !important; justify-content: space-between !important; padding: 20px 24px !important; border-bottom: 1px solid #3a3a3a !important; cursor: move !important; user-select: none !important;" class="pmp-header-drag">
        <div>
          ...
          <span style="margin-left: 8px !important; padding: 4px 8px !important; background: #2a2a2a !important; border-radius: 6px !important; font-size: 12px !important; font-weight: 500 !important; color: #a0a0a0 !important;">v 0.5.3</span>
        </div>
    ...
    addMenuOption: () => {
      const checkMenu = setInterval(() => {
        ...
        if (parametresMenu) {
          ...
          menuOption.textContent = '🎀 PmP v0.5.3';
  ...
  const App = Object.freeze({
     ...
     */
    init: async () => {
      Utils.debugLog('🚀 Initialisation de PimpMyPion v0.5.3');
      ...
      Utils.debugLog('--> PimpMyPion v0.5.3 prêt !');
    }
  });
